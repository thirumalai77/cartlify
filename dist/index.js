import { forwardRef, useState, useCallback, memo, useRef, useMemo, useEffect } from 'react';
...
var Badge = forwardRef(function Badge2({ variant = "custom", label, className, style }, ref) {
  return /* @__PURE__ */ jsx(
    "span",
    {
      ref,
...
function ButtonInner({
  ...
  return /* @__PURE__ */ jsx(
    Tag,
    {
      ...
      ...rest,
      children: isLoading ? /* @__PURE__ */ jsx(SpinnerIcon, {}) : /* @__PURE__ */ jsxs(Fragment, { children: [
        leftIcon && /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: leftIcon }),
        children,
...
var Button = forwardRef(ButtonInner);
var variantClasses3 = {
...
function MinusIcon({ className, color }) {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      ...
      viewBox: "0 0 24 24",
      style: color !== void 0 ? { color } : void 0,
      children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M20 12H4" })
    }
  );
}
...
function StarRating({ rating, count }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", role: "img", "aria-label": `${rating} out of 5 stars`, children: [
    Array.from({ length: 5 }, (_, i) => /* @__PURE__ */ jsx(
      StarIcon,
      {
        className: cn(
          "h-4 w-4",
    ...
    count !== void 0 && /* @__PURE__ */ jsxs("span", { className: "text-xs text-[color:var(--clf-color-muted-foreground)]", children: [
      "(",
      count,
      ")"
    ] })
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-4 flex-1 space-y-3", children: [
          /* @__PURE__ */ jsx("div", { className: "h-4 bg-[color:var(--clf-color-border)] rounded w-3/4" }),
          /* @__PURE__ */ jsx("div", { className: "h-4 bg-[color:var(--clf-color-border)] rounded w-1/2" }),
          /* @__PURE__ */ jsx("div", { className: "h-8 bg-[color:var(--clf-color-border)] rounded w-full mt-4" })
        ] })
      ]
    }
  );
...
function ThumbnailStrip({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        needsScrollArrows && /* @__PURE__ */ jsx(
          "button",
          {
...
function DotCarousel({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-2 left-0 right-0 z-10 flex items-center justify-center gap-1", children: showCounter ? /* @__PURE__ */ jsxs("span", { className: "rounded-full bg-black/50 px-2 py-0.5 text-xs font-medium text-white", children: [
      activeIndex + 1,
      " / ",
      total
    ] }) : Array.from({ length: total }, (_, i) => /* @__PURE__ */ jsx(
      "button",
      {
...
var ProductCard = forwardRef(function ProductCard2({
  product,
  variant = "default",
  isLoading = false,
  isWishlisted = false,
  ...
  if (isLoading) return /* @__PURE__ */ jsx(SkeletonCard, { variant });
  const badgeNode = renderBadge ? renderBadge(product) : (() => {
    ...
    return /* @__PURE__ */ jsx(Badge, { variant: bv, label: labels[bv] ?? "", className: classNames?.badge });
  })();
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              badgeNode && /* @__PURE__ */ jsx("div", { className: "absolute left-2 top-2", children: badgeNode }),
              onWishlistToggle && /* @__PURE__ */ jsx("div", { className: "absolute right-2 top-2", children: /* @__PURE__ */ jsx(
                IconButton,
                {
                  icon: /* @__PURE__ */ jsx(HeartIcon, { filled: isWishlisted }),
              ...
              isDesktop && onAddToCart && inStock && !isCompact && !isHorizontal && /* @__PURE__ */ jsx("div", { className: "absolute inset-x-0 bottom-0 translate-y-full bg-[color:var(--clf-color-surface)]/90 p-2 transition-transform duration-[var(--clf-duration-base)] group-hover:translate-y-0", children: /* @__PURE__ */ jsx(
                Button,
                {
                  variant: "primary",
                  size: "sm",
        ...
        useThumbnailStrip && /* @__PURE__ */ jsx(
          ThumbnailStrip,
          {
            images: allImages,
            imageAlts: allAlts,
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              showRating && product.rating !== void 0 && !isCompact && /* @__PURE__ */ jsx(StarRating, { rating: product.rating, count: product.reviewCount }),
              /* @__PURE__ */ jsxs("div", { className: cn("flex items-baseline gap-2 flex-wrap", classNames?.price), children: [
                /* @__PURE__ */ jsx("span", { className: cn("font-bold", isCompact ? "text-sm" : "text-lg"), children: formatPrice(product.price, currency) }),
                product.originalPrice && product.originalPrice > product.price && /* @__PURE__ */ jsx("span", { className: "text-sm text-[color:var(--clf-color-muted-foreground)] line-through", children: formatPrice(product.originalPrice, currency) })
              ] }),
              !isCompact && onAddToCart && /* @__PURE__ */ jsx("div", { className: cn("mt-auto pt-2", classNames?.actions), children: /* @__PURE__ */ jsx(
                Button,
                {
                  variant: "primary",
...
var CartItemComponent = memo(function CartItemComponent2({
  item,
  currency = "$",
  onQuantityChange,
  onRemove,
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("flex gap-3 py-3", className), children: [
    /* @__PURE__ */ jsx("div", { className: "relative h-16 w-16 shrink-0 overflow-hidden rounded-md bg-[color:var(--clf-color-surface-raised)]", children: /* @__PURE__ */ jsx(
      "img",
      {
        src: item.image,
        alt: item.name,
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-1 flex-col gap-1", children: [
      /* @__PURE__ */ jsx("p", { className: "truncate text-sm font-medium leading-snug", children: item.name }),
      /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-[color:var(--clf-color-primary)]", children: formatPrice(item.price, currency) }),
...
var CartDrawer = forwardRef(function CartDrawer2({
  isOpen,
  onClose,
  items,
  title = "Your Cart",
  ...
  const handleRemoveItem = useCallback((id) => onRemoveItem(id), [onRemoveItem]);
  useEffect(() => {
    if (!isOpen) return;
    const onKeyDown = (e) => {
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("h2", { id: TITLE_ID, className: "text-lg font-semibold leading-snug", children: title }),
                      showItemCount && /* @__PURE__ */ jsxs("p", { className: "text-xs text-[color:var(--clf-color-muted-foreground)]", children: [
                        itemCount,
                        " ",
              ...
              /* @__PURE__ */ jsx("div", { className: cn("flex-1 overflow-y-auto px-4", classNames?.list), children: items.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col items-center justify-center gap-3 py-16 text-center", children: [
                emptyStateIcon ?? /* @__PURE__ */ jsx(ShoppingCartIcon, {}),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-[color:var(--clf-color-muted-foreground)]", children: emptyStateMessage })
              ] }) : /* @__PURE__ */ jsx("ul", { "aria-label": "Cart items", className: "divide-y divide-[color:var(--clf-color-border)]", children: items.map((item) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
                CartItemComponent,
                {
                  item,
                  currency,
              ...
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    showSubtotal && items.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-sm text-[color:var(--clf-color-muted-foreground)]", children: "Subtotal" }),
                      /* @__PURE__ */ jsx("span", { className: "text-base font-semibold", children: formatPrice(subtotal, currency) })
                    ] }),
                    /* @__PURE__ */ jsx(
                      Button,
                      {
                    ...
                    /* @__PURE__ */ jsx(Button, { variant: "ghost", fullWidth: true, onClick: onContinueShopping ?? onClose, children: "Continue Shopping" })
                  ]
                }
              )
            ]
...
function DotsVariant({ size, color }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center", gap }, children: [0, 1, 2].map((i) => /* @__PURE__ */ jsx(
    "div",
    {
      style: {
        width: dotSize,
...
function BarsVariant({ size, color }) {
  ...
  return /* @__PURE__ */ jsx("div", { style: { display: "flex", alignItems: "center", gap, height: size }, children: [0, 1, 2, 3, 4].map((i) => /* @__PURE__ */ jsx(
    "div",
    {
      style: {
        width: barW,
...
var PageLoader = forwardRef(function PageLoader2({
  isVisible = true,
  variant = "spinner",
  size = "md",
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          variant === "spinner" && /* @__PURE__ */ jsx(SpinnerVariant, { size: px, color }),
          variant === "dots" && /* @__PURE__ */ jsx(DotsVariant, { size: px, color }),
          variant === "bars" && /* @__PURE__ */ jsx(BarsVariant, { size: px, color }),
          variant === "pulse" && /* @__PURE__ */ jsx(PulseVariant, { size: px, color })
        ] }),
        text && /* @__PURE__ */ jsx("p", { className: "relative z-10 text-sm font-medium tracking-wide text-[color:var(--clf-color-muted-foreground)]", children: text })
      ]
    }
  );
});
...
function StepCircle({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: step.icon ?? (isCompleted ? /* @__PURE__ */ jsx(CheckIcon, {}) : /* @__PURE__ */ jsx("span", { children: index + 1 }))
    }
  );
}
function StepLabel({
...
function Connector({
  ...
  if (orientation === "horizontal") {
    return /* @__PURE__ */ jsxs("div", { className: cn("relative h-0.5 w-full", className), "aria-hidden": "true", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 h-full w-full rounded-full bg-[color:var(--clf-color-border)]" }),
      /* @__PURE__ */ jsx(
        "div",
        {
          className: cn(
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("relative mt-1 w-0.5 flex-1 min-h-6", className), "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 w-full rounded-full bg-[color:var(--clf-color-border)]" }),
    /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
...
function StepItem({
  ...
  if (orientation === "horizontal") {
    const inner = onClick ? /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        "data-step-btn": "",
    ...
    return /* @__PURE__ */ jsxs(
      "li",
      {
        ...
        children: [
          !isFirst && /* @__PURE__ */ jsxs(
            "div",
            {
              className: cn("absolute top-4 left-0 right-1/2 h-0.5", classNames?.connector),
              "aria-hidden": "true",
              children: [
                /* @__PURE__ */ jsx("div", { className: "h-full w-full rounded-full bg-[color:var(--clf-color-border)]" }),
                /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: cn(
  ...
  return /* @__PURE__ */ jsxs("li", { "aria-current": isActive ? "step" : void 0, className: cn("flex gap-4", classNames?.step), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: cn("flex flex-col justify-center", !isLast && "pb-8"), children: onClick ? /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        onClick,
...
var CheckoutStepper = forwardRef(
  function CheckoutStepper2({
    ...
    return (
      ...
      /* @__PURE__ */ jsx("div", { onKeyDown: handleKeyDown, children: /* @__PURE__ */ jsx(
        "ol",
        {
          ref,
